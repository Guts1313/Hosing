...
namespace DesktopAppMediaBazaar.CustomElements.Controls
{
    ...
    public class CustomTextBoxV2 : Control
    {
        #region Fields
        ...
        private void TextBox_Enter(object sender, EventArgs e)
        {
            if (ColorBordersOnEnter)
                borderColor = ColorTranslator.FromHtml("#A85FE1");
        ...
        {
            if (ColorBordersOnEnter)
                borderColor = ColorTranslator.FromHtml("#D6D6D6");
        ...
        public CustomTextBoxV2()
        {
            ...
            _WatermarkColor = ColorTranslator.FromHtml("#E5E5E5");
        ...
        private void AddTextBox()
        {
            ...
            tbCtrl.BackColor = ColorTranslator.FromHtml("#E5E5E5");

            ForeColor = ColorTranslator.FromHtml("#E5E5E5");
