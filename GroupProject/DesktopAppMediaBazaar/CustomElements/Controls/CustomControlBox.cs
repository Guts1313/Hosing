...
namespace DesktopAppMediaBazaar.CustomElements.Controls
{
    public class CustomControlBox : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var minimizeBtnBrush = new SolidBrush(_EnableMinimize ? ColorTranslator.FromHtml("#9C54D5") : 
            ...
            var maximizeBtnBrush = new SolidBrush(_EnableMaximize ? ColorTranslator.FromHtml("#A0A0A0") : 
                                                                    ColorTranslator.FromHtml("#9C54D5"));
            ...
            var closeBtnBrush = new SolidBrush(ColorTranslator.FromHtml("#9C54D5"));

            if (hover_close)
            {
                using (var backColor = new SolidBrush(ColorTranslator.FromHtml("#9C54D5")))
